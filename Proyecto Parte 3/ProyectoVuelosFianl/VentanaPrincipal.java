...
public class VentanaPrincipal extends javax.swing.JFrame {
	...
	private void loguearAdmin() {
		...
		String url = "jdbc:mysql://localhost:3306/vuelos?serverTimezone=America/Argentina/Buenos_Aires";
		...
		try {
			...
			if (option == 0)
				if (existeEmpleado(usuario.getText(), new String(pass.getPassword()), con)) {
					iniciarEmpleado(usuario.getText());
				} else {
	...
	private void iniciarEmpleado(String legajo) {
		this.ventanaEmpleado = new VentanaEmpleado(legajo);
